...
BOT_NAME = getenv("BOT_NAME", "SpotifyMusic")
...
BOT_USERNAME = getenv("BOT_USERNAME", "SpotifyMusicBot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "SpotifyAsisstent")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "SpotifySupport_id")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "SpotifyBotProject")
# isi dengan username kamu tanpa simbol @
OWNER_NAME = getenv("OWNER_NAME", "KaisenXXD")
# fill with your nickname
ALIVE_NAME = getenv("ALIVE_NAME", "Kaisen")
...
UPSTREAM_REPO = os.environ.get(
    "UPSTREAM_REPO", "https://github.com/KaisenXXD/Spotify-Music"
)
